...
# LSP support in your editor

It is possible to use [Bacon Language Server](../community/bacon-ls) for a complete Language Server Protocol support
in your favorite editor, currently supporting Vim, Neovim and VSCode.
